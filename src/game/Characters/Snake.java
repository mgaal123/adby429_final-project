...
import game.Games.GameWorld;
import org.jbox2d.common.Vec2;

public class Snake extends DynamicBody implements StepListener {
    private static final float radius = 1.0f;
    private static final Shape ballShape = new CircleShape(radius);
    private static final BodyImage ballImage =
            new BodyImage("data/snake.png", 2*radius);
